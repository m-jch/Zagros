...
@section('content')
    <div class="col-md-6 col-md-offset-3">
        ...
        @endif
        {{Form::open(array('action' => array('MilestoneController@postCreateBug', $project->url, $milestone->url), 'class' => 'form-horizontal', 'role' => 'form'))}}
    ...
    <script>
        $(function() {
            ...
            var parent = $('#parent').magicSuggest({
                data: '{{URL::action('MilestoneController@postBlueprints', array($project->url, $milestone->url))}}',
